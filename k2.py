...
if __name__ == "__main__":
    try:
        ...
        points = []
        for _ in range(n):
            point_input = input("Введите координаты точки 'x,y,z': ")
        ...
        if n >= 2:
            v1 = Vector.from_string(input("Введите первый вектор 'x,y,z': "))
            v2 = Vector.from_string(input("Введите второй вектор 'x,y,z': "))
            print(f"Площадь параллелограмма: {parallelogram_area(v1, v2)}")

        if n >= 3:
            v1 = Vector.from_string(input("Введите первый вектор для параллелепипеда 'x,y,z': "))
            v2 = Vector.from_string(input("Введите второй вектор для параллелепипеда 'x,y,z': "))
            v3 = Vector.from_string(input("Введите третий вектор для параллелепипеда 'x,y,z': "))
